...
export const FINAL_LETTER: FinalLetterData = {
  ...
  title: 'Bia,',
  paragraphs: [
    'Feliz mais um ano de muitos!!!',
    'Mais um ano de realizações, provações, alegrias, tristeza, mas principalmente de companheirismo.\nMais um ano fazendo a melhor escolha todos os dias: compartilhar cada momento com você.',
    'Esse foi um ano com momentos "altos" muito altos e "baixos" muito baixos, e isso só reforça o tamanho do nosso amor. Estamos juntos para compartilhar as risadas e também juntos para conversar e superar adversidades, solidificando cada vez mais nosso futuro.',
    'Te amo infinito!!!\nBjjsss minha linda 💜💜',
  ],
